#include <iostream>               //EN ESTE CLASE CON LOS ALGORITMOS COMO METODOS USAMOS VALORES GRANDES EN A Y EN B
                                  //Y ASI MEDIR LA EFICIENCIA DE ESTOS EN CADA METODO TIENE UN COMENTARIO SOBRE EL ALGORITMO
using namespace std;              //(SEGUIMIENTO) Y EN EL MAIN SE MIDE LA DURACION DE CADA UNO CON LOS MISMOS VALORES
#include <stdlib.h>
#include <ctime>
